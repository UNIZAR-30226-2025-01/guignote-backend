...
urlpatterns = [
    ...
    path('chat/<int:partida_id>/', views_individual.obtener_chat_partida, name='obtener_chat_partida'),
    ...
    path('2v2/chat/<int:partida_id>/', views_parejas.obtener_chat_partida_2v2, name='obtener_chat_partida_2v2'),
]
